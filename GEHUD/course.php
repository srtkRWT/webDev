        ...
        <!-- ................ -->
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    printf("<button class=\"btn btn-link collapsed \" data-toggle=\"collapse\" data-target=\"#collapse%s\" aria-expanded=\"false\" aria-controls=\"collapse%s\">", $row["course_head_name"], $row["course_head_name"]);
